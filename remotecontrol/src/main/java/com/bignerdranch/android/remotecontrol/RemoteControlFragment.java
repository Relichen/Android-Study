...
//        Button zeroButton = (Button) v.findViewById(R.id.fragment_remote_zeroButton);
//        zeroButton.setOnClickListener(numberButtonListener);
//        Button oneButton = (Button) v.findViewById(R.id.fragment_remote_oneButton);
//        oneButton.setOnClickListener(numberButtonListener);

        TableLayout tableLayout = (TableLayout) v.findViewById(R.id.fragment_remote_control);
        int number = 1;
